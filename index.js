...
function setThemeColors(isDarkTheme) {
    ...
    const newTheme = isDarkTheme ? darkTheme : lightTheme;
    // const newImagesTheme = isDarkTheme ? imagesDarkTheme: imagesLightTheme;
    // const imageContainers = document.getElementsByClassName('image-container');
    // Array.from(imageContainers).forEach(el => {
    //     isDarkTheme ? el.classList.remove('light') : el.classList.add('light');
    // });
